...
//		test1();
	...
	public static void test2() {
		...
		//모두 출력해보기
		MyLinkedList<Emp> list=new MyLinkedList<Emp>();
		Emp e1=new Emp("김철수", 165);
		Emp e2=new Emp("이갑수", 172);
		Emp e3=new Emp("박광수", 170);
		list.addLast(e1);
...
//		list.print();
		...
		findEmp=list.search(new Emp("박광수", 0), Emp.Name_Order);
...
//		list.remove(new MyLinkedList.Node<String>("C", null)); //==>주소값이 다르므로 삭제되지 않는다
		list.remove("C");
		list.print();
