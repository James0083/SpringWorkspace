...
<script>
	...
	const goCart=function(){
		...
		// frm.method="get"; //나중에 post로 수정하기
		frm.submit();
		
	}
	const goOrder=function(){
		//attr(속성명, 값): 정적인 속성값을 설정할 때
		//prop(속성명, 값): 기능적인 속성값을 설정할 때
		//ppnum, pqty가 파라미터로 넘어감
            ...
            <table class="table">
               ...
               <tbody>
                  <tr>
                     ...
                     <img src="resources/product_images/${item.pimage1}" class="img-fluid" style="width: 70%;"> <!-- </a> -->
                     </a></td>
