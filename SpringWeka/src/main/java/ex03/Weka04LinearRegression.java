...
public class Weka04LinearRegression {
	...
	public void predictHouse() throws Exception{
		...
		//Instance lastHouse=data.lastInstance();
	...
	public static void main(String[] args) throws Exception {
		...
		String file="/Users/jaewonyou/Applications/weka/weka-3-9-3/data/House/house.arff";
		String file2="/Users/jaewonyou/Applications/weka/weka-3-9-3/data/House/myhouse.arff";
		app.loadArff(file);
		app.generateModel();
		app.predictHouse();
