...
public class Weka07ApriorAssociation {
	
	String file="/Users/jaewonyou/Applications/weka/weka-3-9-3/data/Book/CharlesBookClub_preprocess.arff";
	DataSource ds;
	Instances data;
	...
	public void association() throws Exception{
		...
		//metricType를 향상도(Lift)로 지정(디폴트값은 신회도(Comfidence))
		//신뢰도:0, 향상도:1
		model.setMinMetric(1.5);
		//향상도 최도값을 1.5로 지정한다.
		//A를 구했을 때 B를 함께 구매할 비율리 1.5배 이상 나타난다
		model.setNumRules(10);
		//학습진행
		model.buildAssociations(data);
		//evaluate은 필요없고, 연관규칭 추출을 해야한다
	...
	//전조현상 A와 병행션상 B에서 발생한 모든 속성값별 발생횟수를 계산해보자
	...
	public static void main(String[] args) throws Exception {
		Weka07ApriorAssociation app=new Weka07ApriorAssociation();
