...
public class Weka02DecisionTree {
	static String file1="/Users/jaewonyou/Applications/weka/weka-3-9-3/data/UniversalBank/UniversalBank_preprocess.arff";
	static String file2="/Users/jaewonyou/Applications/weka/weka-3-9-3/data/UniversalBank/UniversalBank_realData.arff";
	...
	private void generateModel_Evaluate() {
		...
		model.setMinNumObj(10);//노드 당 최소 인스턴스 수 지정 => 설정값이 클수록 노드수가 줄어들면서 나무의 길이도 낮아짐
		...
		try {
			...
			int nums=(int)eval.numInstances();//분류대상 데이터수
			int accuracy=(int)eval.correct();//정분류 건수(맞춘 데이터수)
