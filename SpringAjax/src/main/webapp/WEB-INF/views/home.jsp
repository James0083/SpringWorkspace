	  	...
	  	$(function(){
	  		$('#btn1').click(()=>{
	  			...
	  			$.ajax({
					...
					success:function(res){
						...
						//<=> JSON.parse():문자열(json형태 문자열)을 파싱해서 json객체로 반환
			...
			$('#frm').submit((e)=>{
				...
				$.ajax({
					...
					url:'ajaxFile',
					data:frmData,
					contentType:false, //multipart/form-data 로 보내려면 false로 지정해야 한다
